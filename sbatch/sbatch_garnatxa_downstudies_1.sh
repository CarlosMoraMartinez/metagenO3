...
nextflow run all.nf -c config/launch_downloaded_datasets/run_garnatxa_study1.config -profile conda -resume -with-report report.html -with-dag pipeline_dag.html