...
nextflow run all.nf -c config/run_samples_garnatxa_HumannCoralsFaltan.config -profile conda -resume -with-report report.html -with-dag pipeline_dag.html